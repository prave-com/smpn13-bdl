                            ...
                            <div class="mb-6">
                                ...
                                <div class="mt-1">
                                    <img id="{{ $image }}-preview"
                                        ...
                                        alt="Pratinjau {{ $image }}"
                                        class="{{ $facility->{$image} ? '' : 'hidden' }} w-full md:w-64 h-48 object-cover rounded-lg cursor-pointer shadow-md transition duration-300 ease-in-out transform hover:scale-105 border-2 border-dashed border-transparent focus:border-blue-500 {{ $facility->{$image} ? '' : 'hidden' }}"
