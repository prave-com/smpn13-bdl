                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('facilities.update', $facility) }}" method="POST"
                        ...
                        <div class="flex justify-end mt-8">
                            <button type="submit"
                                class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-md shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition duration-300 ease-in-out">Simpan
                                Perubahan</button>
                        </div>
                    </form>
                </div>
